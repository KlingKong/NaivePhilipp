 ...
 */
public class NaivePhilippNodePlugin extends Plugin {
    // The shared instance.
    private static NaivePhilippNodePlugin plugin;

    /**
     * The constructor.
     */
    public NaivePhilippNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NaivePhilippNodePlugin getDefault() {
        return plugin;
    }
